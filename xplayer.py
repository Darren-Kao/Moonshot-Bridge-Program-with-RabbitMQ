...
# URL for CloudAMQP
cloudAMQP = 'amqps://tqmfuezu:TX70gchKHs2EPWC9cC_A9rucjc-b-t_u@rattlesnake.rmq.cloudamqp.com/tqmfuezu' # Paste instance URL here
...
for i in range (1, 14):
    ...
    if inMsg[0] == 1:
        ...
        if contractPlayer == False:
            tricksLeft = 8 - contract[1] - tricksWon
        if win == 0:
            if tricksLeft > 1:
    ...
    if inMsg[0] == 0:
        ...
        if contractPlayer == True:
            tricksLeft = 8 - contract[1] - tricksLost
        if contractPlayer == False:
